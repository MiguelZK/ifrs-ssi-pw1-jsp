...
<head>
	...
	<title>Edição de Programador (não é lugar pra tu estar olhando...)</title>
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right">
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right">
					...
					">
						...
						<span class="nav-link-text">Editar Programador</span>
					</a>
				</li>
			</ul>
			...
			<div class="card-body">
                   <form method ="POST" action="direcionaEditProgramador.jsp">
					...
					<div class="form-group">
						<label for="nomeProg">Nome:</label>
						<input type="text" class="form-control" id="nome" name="nome"
						placeholder="Digite seu Nome:" value="<%=p.getNome()%>">
					</div>
					<div class="form-group">
						<label for="endProg">Endereço:</label>
						<input type="text" class="form-control" id="endereco" name="endereco"
						placeholder="Digite seu Endereço:" value="<%=p.getEndereco()%>">
					</div>
										<div class="form-group">
					...
					<div class="form-group">
						<label for="linguagemProg">Linguagem:</label> <input type="text"
							class="form-control" id="linguagemProg" name="linguagemProg"
					...
					<div class="form-group">
						<label for="projetosProg">Projetos:</label> <input type="text"
							...
							placeholder="Digite os Projetos em andamento, separados por Ponto-e-Vírgula:">
					</div>
					<button class="btn btn-primary btn-block">Salvar edição</button>
				</form>
				</div>
			</div>
		</div>
